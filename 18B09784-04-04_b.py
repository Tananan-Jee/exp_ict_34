...
#コンパイル方法：python3 18B09784-04-04_b.py
#実行方法：ターミナル上で python3 18B09784-04-04_b.py を実行
...
print("[00100001]*[11111100]=" + mul('[00100001]','[11111100]',f_int,len_f,m))
print("[00010101]*[10101111]=" + mul('[00010101]','[10101111]',f_int,len_f,m))
print("[00111100]*[00111011]=" + mul('[00111100]','[00111011]',f_int,len_f,m))
print("")
print("[00000011]/[01110110]=" + div('[00000011]','[01110110]',f_int,len_f,m,p))
print("[10100000]/[00110001]=" + div('[10100000]','[00110001]',f_int,len_f,m,p))
print("[10111011]/[00010100]=" + div('[10111011]','[00010100]',f_int,len_f,m,p))
