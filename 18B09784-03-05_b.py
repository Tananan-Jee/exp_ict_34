...
#コンパイル方法：python3 18B09784-03-05_b.py
#実行方法：ターミナル上で python3 18B09784-03-05_b.py を実行
...
print("INPUT: dual.txt")
with open("dual.txt") as file:
...
num=len(c_g) #number of element in c = |c| = 2^k
for i in range(n+1):
    B_w[i]=int(B_w[i]/num)
